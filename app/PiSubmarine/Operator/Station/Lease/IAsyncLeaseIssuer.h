...
namespace PiSubmarine::Operator::Station::Lease
{
	...
	public:
		...
		[[nodiscard]] virtual Error::Api::Result<::PiSubmarine::Lease::Api::LeaseGrant>
		...
		[[nodiscard]] virtual Error::Api::Result<::PiSubmarine::Lease::Api::Lease>
		...
		[[nodiscard]] virtual Error::Api::Result<void>
