...
if(EXISTS "${CURRENT_INSTALLED_DIR}/tools/Qt6/bin")
    set(ENV{PATH} "${CURRENT_INSTALLED_DIR}/tools/Qt6/bin;$ENV{PATH}")
endif()
...
if(VCPKG_TARGET_IS_WINDOWS AND VCPKG_LIBRARY_LINKAGE STREQUAL "static")
    foreach(qt_module IN ITEMS Qt6Core Qt6Gui Qt6Qml Qt6Quick)
        foreach(qt_suffix IN ITEMS lib prl)
            if(EXISTS "${CURRENT_INSTALLED_DIR}/debug/lib/${qt_module}d.${qt_suffix}")
                file(COPY
                    "${CURRENT_INSTALLED_DIR}/debug/lib/${qt_module}d.${qt_suffix}"
...
vcpkg_replace_string(
    "${SOURCE_PATH}/subprojects/gst-plugins-bad/ext/qt6d3d11/gstqsg6d3d11node.h"
    "#include <gst/d3d11/gstd3d11.h>\n#include <QtQuick/QQuickItem>"
    "#include <gst/d3d11/gstd3d11.h>\n#ifdef restrict\n#undef restrict\n#endif\n#include <QtQuick/QQuickItem>"
)

vcpkg_replace_string(
    "${SOURCE_PATH}/subprojects/gst-plugins-bad/ext/qt6d3d11/gstqt6d3d11videoitem.h"
    "#include <gst/d3d11/gstd3d11.h>\n#include <QQuickItem>"
    "#include <gst/d3d11/gstd3d11.h>\n#ifdef restrict\n#undef restrict\n#endif\n#include <QQuickItem>"
)

vcpkg_replace_string(
    "${SOURCE_PATH}/subprojects/gst-plugins-bad/ext/qt6d3d11/meson.build"
    "qt6qml_dep = dependency('qt6', modules : ['Core', 'Gui', 'Qml', 'Quick'],\n                        method: qt6_method, required: qt6_option)\nif not qt6qml_dep.found()\n  subdir_done()\nendif"
    "qt6core_dep = dependency('Qt6Core', method: 'cmake', required: qt6_option)\nqt6gui_dep = dependency('Qt6Gui', method: 'cmake', required: qt6_option)\nqt6qml_dep = dependency('Qt6Qml', method: 'cmake', required: qt6_option)\nqt6quick_dep = dependency('Qt6Quick', method: 'cmake', required: qt6_option)\nif not qt6core_dep.found() or not qt6gui_dep.found() or not qt6qml_dep.found() or not qt6quick_dep.found()\n  subdir_done()\nendif"
)

vcpkg_replace_string(
    "${SOURCE_PATH}/subprojects/gst-plugins-bad/ext/qt6d3d11/meson.build"
    "dependencies : [gst_dep, gstvideo_dep, gstd3d11_dep, qt6qml_dep],"
    "dependencies : [gst_dep, gstvideo_dep, gstd3d11_dep, qt6core_dep, qt6gui_dep, qt6qml_dep, qt6quick_dep],"
)
...
vcpkg_replace_string(
    ...
    "have_qt6d3d11 = true\nmoc_files = qt6_mod.preprocess(moc_headers : moc_headers, method: qt6_method)\nqt6d3d11_link_args = []\nif host_system == 'windows'\n  qt6_lib_suffix = ''\n  pcre2_lib_name = 'pcre2-16.lib'\n  if get_option('debug')\n    qt6_lib_suffix = 'd'\n    pcre2_lib_name = 'pcre2-16d.lib'\n  endif\n  qt6d3d11_link_args += [\n    'Qt6Network' + qt6_lib_suffix + '.lib',\n    'Qt6PacketProtocol' + qt6_lib_suffix + '.lib',\n    'Qt6QmlMeta' + qt6_lib_suffix + '.lib',\n    'Qt6QmlModels' + qt6_lib_suffix + '.lib',\n    'Qt6QmlWorkerScript' + qt6_lib_suffix + '.lib',\n    'double-conversion.lib',\n    'md4c.lib',\n    pcre2_lib_name,\n    'synchronization.lib',\n    'mpr.lib',\n    'userenv.lib',\n    'authz.lib',\n    'kernel32.lib',\n    'netapi32.lib',\n    'ntdll.lib',\n    'ole32.lib',\n    'runtimeobject.lib',\n    'shell32.lib',\n    'user32.lib',\n    'uuid.lib',\n    'version.lib',\n    'winmm.lib',\n    'dnsapi.lib',\n    'iphlpapi.lib',\n    'advapi32.lib',\n    'winhttp.lib',\n    'ws2_32.lib',\n    'crypt32.lib',\n    'secur32.lib',\n    'bcrypt.lib',\n    'ncrypt.lib',\n    'd3d11.lib',\n    'dxgi.lib',\n    'dxguid.lib',\n    'd3d12.lib',\n    'gdi32.lib',\n    'uxtheme.lib',\n    'd2d1.lib',\n    'dwrite.lib',\n  ]\nendif\nqt6d3d11_extra_dep = declare_dependency(link_args : qt6d3d11_link_args)\ngstqt6d3d11 = library('gstqt6d3d11', gstqt6d3d11_sources, moc_files,\n  c_args : gst_plugins_bad_args + ['-DGST_USE_UNSTABLE_API'],\n  cpp_args : gst_plugins_bad_args + ['-DGST_USE_UNSTABLE_API'],\n  link_args : noseh_link_args,\n  include_directories: [configinc, libsinc],\n  dependencies : [gst_dep, gstvideo_dep, gstd3d11_dep, qt6core_dep, qt6gui_dep, qt6qml_dep, qt6quick_dep, qt6d3d11_extra_dep],\n  override_options : ['cpp_std=c++17'],\n  install: true,\n  install_dir : plugins_install_dir\n)"
)
...
vcpkg_configure_meson(
    ...
    OPTIONS
        ...
        -Dgst-plugins-good:qt-method=qmake
        ...
        -Dgst-plugins-bad:qt-method=qmake
